    ...
    <div className="min-h-screen py-8 sm:py-12 lg:py-16 px-6 sm:px-8 lg:px-12 xl:px-16 2xl:px-20 w-full space-y-8">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <span className="text-xs text-white bg-white/10 border border-white/10 px-3 py-1 rounded-full">
            Status: {space.status.toUpperCase()} • {space.isActive ? 'Active' : 'Inactive'}
          </span>
          <Link href={`/provider/spaces/${space.id}/edit`}>
      ...
      {imageCount > 0 ? (
        <div className="relative flex justify-center">
          <div
            className="relative w-full max-w-3xl overflow-hidden rounded-xl border border-white/10"
